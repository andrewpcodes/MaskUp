...
This project is all about keeping people safe. A project using the OpenCV to use facial rec and some custom haar files to detect wheater someone has a mask properly on.
